        ...
        <div class="container" >
            <div class="row main-top-margin text-center">
                <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1" data-scrollreveal="enter left and move 100px, wait 0.5s">
                    ...
                    <form align="left" style="font-size:100%; margin-top:30px;">
                    ...
                    <table data-scrollreveal="enter left and move 100px, wait 0.5s">
                        ...
                        <tbody class="table-hover">
                            ...
                            ?>
                                    ...
                                    <td class="text-left"><a href = "<?php echo base_url().'index.php/mahasiswa/krs/delete/'.$row->idpilihan?>">Delete</a></td>
                                    <?php else: ?>
            ...
            <div align="left" data-scrollreveal="enter left and move 100px, wait 0.5s">
                <a href="isikrs" style="font-size:20px;"><b>Isi KRS</b></a>
            </div>
