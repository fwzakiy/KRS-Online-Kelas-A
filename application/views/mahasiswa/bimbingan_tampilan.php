        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="<?php echo base_url(); ?>index.php/mahasiswa/home">HOME</a></li>
                    <li><a href="<?php echo base_url(); ?>index.php/mahasiswa/krs">KRS</a></li>
                    <li><a href="<?php echo base_url(); ?>index.php/mahasiswa/bimbingan">BIMBINGAN</a></li>
                    <li><a href="<?php echo base_url(); ?>index.php/mahasiswa/home/logout">LOG OUT</a></li>
            </div>
    ...
    <div id="bimbingan-section" >
        <div class="container" >
            ...
            <div data-scrollreveal="enter top and move 100px, wait 0.5s">
                <form action="<?php echo base_url().'index.php/mahasiswa/bimbingan/kirimpesan'?>" method="POST" accept-charset="utf-8">
                    <h3>Dosen</h3>
                    <select name="nim">
